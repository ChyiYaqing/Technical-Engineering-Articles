...
|---|---|---|
| [Design Bit.ly and Pastebin](https://x.com/Harry_The_Nerd/status/2044672371546877964) | Walkthrough of designing URL shorteners and paste-sharing services. | 2026-04-16 |
| [Design A Notification System](https://x.com/Harry_The_Nerd/status/2044839667267494292) | System design for a scalable multi-channel notification system. | 2026-04-16 |
| [Design A Rate Limiter](https://x.com/Harry_The_Nerd/status/2045533839649624096) | Algorithms and architecture for rate limiting at scale. | 2026-04-18 |
| [Design Autocomplete For Search Engines](https://x.com/Harry_The_Nerd/status/2045906641967833171) | Designing a low-latency autocomplete/typeahead system. | 2026-04-19 |
| [Design a Load Balancer](https://x.com/Harry_The_Nerd/status/2046465659551576395) | How load balancers work and how to design one from scratch. | 2026-04-21 |
| [Design a Content Delivery Network](https://x.com/Harry_The_Nerd/status/2046578404758295032) | CDN architecture, caching strategies, and edge delivery. | 2026-04-21 |
| [Design a Distributed Key-Value store](https://x.com/Harry_The_Nerd/status/2047329176982827353) | Designing a distributed key-value store with partitioning and replication. | 2026-04-23 |
| [Design A Distributed Cache](https://x.com/Harry_The_Nerd/status/2048052028174463278) | Architecture of a distributed caching layer. | 2026-04-25 |
| [Design an Authentication System](https://x.com/Harry_The_Nerd/status/2048758919770816850) | Designing a scalable authentication and session management system. | 2026-04-27 |
| [Tricky HLD Patterns for interviews](https://x.com/Harry_The_Nerd/status/2056739488114856226) | Commonly missed high-level design patterns for interviews. | 2026-05-19 |
| [Design Consistent Hashing](https://x.com/Harry_The_Nerd/status/2057098732328648808) | How consistent hashing works and where it's used. | 2026-05-20 |
| [Design A Unique ID Generator in Distributed Systems](https://x.com/Harry_The_Nerd/status/2057461354114728238) | Designing a distributed unique ID generator (e.g. Snowflake-style). | 2026-05-21 |
| [Design A News-Feed System](https://x.com/Harry_The_Nerd/status/2058553384735842654) | System design for a scalable news feed. | 2026-05-24 |
| [Design A Chat System](https://x.com/Harry_The_Nerd/status/2061445321910284589) | System design for a real-time chat application. | 2026-06-01 |
| [Design Youtube](https://x.com/Harry_The_Nerd/status/2062909779576791167) | High-level design walkthrough for a YouTube-like system. | 2026-06-05 |
| [Design Spotify](https://x.com/Harry_The_Nerd/status/2063952850531897396) | System design for a music streaming platform like Spotify. | 2026-06-08 |
| [Design Instagram](https://x.com/Harry_The_Nerd/status/2065074213665579192) | System design for a photo/video sharing platform like Instagram. | 2026-06-12 |
| [Design Tinder](https://x.com/Harry_The_Nerd/status/2065790968448909572) | System design for a location-based matching app like Tinder. | 2026-06-13 |
| [Design Reddit](https://x.com/Harry_The_Nerd/status/2067615247259811850) | System design for a forum/link-aggregation platform like Reddit. | 2026-06-18 |
...
| Article | Description | Date |
|---|---|---|
| [LLD Concepts](https://x.com/Harry_The_Nerd/status/2055635966568620167) | Core low-level design concepts for interviews and practice. | 2026-05-16 |
| [Design a basic Music System](https://x.com/Harry_The_Nerd/status/2056620076246479055) | Low-level design of a basic music streaming/playback system. | 2026-05-19 |
| [Design a Parking Lot](https://x.com/Harry_The_Nerd/status/2057821348450402614) | Classic LLD problem: designing a parking lot system. | 2026-05-22 |
| [Design Youtube](https://x.com/Harry_The_Nerd/status/2060001018134553006) | Low-level design walkthrough for a YouTube-like system. | 2026-05-28 |
| [Design a Vending Machine](https://x.com/Harry_The_Nerd/status/2060348729929175403) | Classic LLD problem: designing a vending machine. | 2026-05-29 |

## Backend Engineering

| Article | Description | Date |
|---|---|---|
| [HTTP & Routing](https://x.com/Harry_The_Nerd/status/2053366145995178087) | Core concepts of HTTP and routing in backend systems. | 2026-05-10 |
| [Serialization, Deserialization, Authentication and Authorization](https://x.com/Harry_The_Nerd/status/2053487726033559704) | Backend fundamentals: serialization, auth, and authz. | 2026-05-10 |
| [Validation, Transformation, Controllers, Middlewares](https://x.com/Harry_The_Nerd/status/2053882356071911853) | Request handling patterns: validation, transformation, controllers, middleware. | 2026-05-11 |
| [Rest API Design](https://x.com/Harry_The_Nerd/status/2054882198604628305) | Principles and best practices for designing REST APIs. | 2026-05-14 |
| [Databases in Depth Part-1](https://x.com/Harry_The_Nerd/status/2073772366094602241) | Part 1 of a deep dive into database internals. | 2026-07-05 |
| [Databases in Depth Part-2](https://x.com/Harry_The_Nerd/status/2075942037732667812) | Part 2 of a deep dive into database internals. | 2026-07-11 |
| [Databases in Depth Part-3](https://x.com/Harry_The_Nerd/status/2076649413435687097) | Part 3 of a deep dive into database internals. | 2026-07-13 |
| [Caching, Task Queues, Error Handling, Logging, Monitoring](https://x.com/Harry_The_Nerd/status/2077400118647750968) | Backend fundamentals: caching, task queues, error handling, logging, monitoring. | 2026-07-15 |
| [Security, Scaling & Performance, Concurrency & Parallelism](https://x.com/Harry_The_Nerd/status/2077722979882963122) | Backend fundamentals: security, scaling, performance, concurrency. | 2026-07-16 |
...
| [A Complete Guide For Claude Certified Architect Foundations (CCA-F) Exam](https://x.com/Harry_The_Nerd/status/2069050669487809004) | Guide covering the Claude Certified Architect Foundations exam. | 2026-06-22 |
| [Netflix Recommendation System - Machine Learning System Design](https://x.com/Harry_The_Nerd/status/2069785739810705773) | ML system design breakdown of Netflix's recommendation engine. | 2026-06-24 |
